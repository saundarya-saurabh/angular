...
@Component({
  selector: 'app-nft-eth-staking',
  templateUrl: './nft-eth-staking.component.html',
  styleUrls: ['./nft-eth-staking.component.scss']
})
export class NftEthStakingComponent implements OnInit {
  ...
  async ngOnInit() {
    ...
    if (this.userAccount == undefined || !this.userAccount.length) {
      ...
      this.login = true;
      this.contractInstance = await this.apis.exportInstance(environment.poolAddressETHLP, environment.commanpoolABI);
      this.contractLpInstance = await this.apis.exportInstance(environment.ethLpaddressETHLP, environment.commanpoolABI);
      ...
      await this.allowance(this.contractLpInstance, this.userAccount, environment.poolAddressETHLP, this.apis);
  ...
  async onClickApprove() {
    ...
    if (this.approveForm.invalid) {
      ...
      if (this.approveForm.value.amount == 0) {
        ...
        let address = environment.poolAddressETHLP;
        let instance = this.contractLpInstance;
