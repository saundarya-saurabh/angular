...
@Component({
  selector: 'app-liquidity-pool-new',
  templateUrl: './liquidity-pool-new.component.html',
  styleUrls: ['./liquidity-pool-new.component.scss']
})
export class LiquidityPoolNewComponent implements OnInit {
  ...
  perHour: any = 2.083333 ;
  perDay: any = 50.000000;
  perWeek: any = 350.000000;
  ...
  async ngOnInit() {
    ...
    if (this.userAccount == undefined || !this.userAccount.length) {
      ...
      this.login = true;
      this.contractInstance = await this.apis.exportInstance(environment.poolAddressN, environment.commanpoolABI);
      ...
      await this.allowance(this.contractLpInstance, this.userAccount, environment.poolAddressN, this.apis);
  ...
  async onClickApprove() {
    ...
    if (this.approveForm.invalid) {
      ...
      if (this.approveForm.value.amount == 0) {
        ...
        let address = environment.poolAddressN;
        let instance = this.contractLpInstance;
