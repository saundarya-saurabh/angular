...
@Component({
  selector: 'app-rsk-bundle-asset1',
  templateUrl: './rsk-bundle-asset1.component.html',
  styleUrls: ['./rsk-bundle-asset1.component.scss']
})
export class RskBundleAsset1Component implements OnInit {
  ...
  async fetchUserBets(instance, userAccount) {
    await this.RSKService.fetchUserBets(instance, userAccount, this.bundleId).then((data: any) => {
