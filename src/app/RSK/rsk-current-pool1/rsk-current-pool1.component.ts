...
@Component({
  selector: 'app-rsk-current-pool1',
  templateUrl: './rsk-current-pool1.component.html',
  styleUrls: ['./rsk-current-pool1.component.scss']
})
export class RskCurrentPool1Component implements OnInit {
