...
@Component({
  selector: 'app-bundle-asset',
  templateUrl: './bundle-asset.component.html',
  styleUrls: ['./bundle-asset.component.scss']
})
export class BundleAssetComponent implements OnInit {
