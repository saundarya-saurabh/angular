...
@Component({
  selector: 'app-current-pool',
  templateUrl: './current-pool.component.html',
  styleUrls: ['./current-pool.component.scss']
})
export class CurrentPoolComponent implements OnInit {
